...
function(msg msg_type msg_var)
    if(WITH_MSG_DEBUG)
        set(sourceFile " [${CMAKE_CURRENT_LIST_FILE}]")
        str2color(COLOR ${WITH_MSG_DEBUG} sourceFile)
    endif()
    if(${msg_type} STREQUAL HIGH OR ${msg_type} STREQUAL INFO)
        str2color(COLOR magenta msg_var)
        message(" ## ${msg_var}${sourceFile}")
    ...
    elseif(${msg_type} STREQUAL WARN)
        ...
        message("${msg_type} ${msg_var}${sourceFile}")
    endif()
endfunction()
...
if(WITH_CMAKE_UTILS_DEMO)
    set(LOG_FILENAME ${CMAKE_BINARY_DIR}/utils.log)
    set(WITH_LOGGING TRUE)
    include(${CMAKE_CURRENT_LIST_DIR}/log.cmake)
    message("\n===========================")
    message("  utils.cmake Demo")
    message("===========================\n")
    ...
    set(WITH_MSG_DEBUG black)
    msg(WARN "This is a WARN")
    msg(ERR "This is a ERR")
    set(WITH_MSG_DEBUG blue)
    msg(CRIT "This is a CRIT")
    unset(WITH_MSG_DEBUG)
    msg(OK "This is a OK")
